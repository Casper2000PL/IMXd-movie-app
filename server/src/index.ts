...
import { contentGenresRouter } from "./routes/content-genres";
...
app.use(
  ...
  cors({
    ...
    allowHeaders: ["Content-Type", "Authorization", "Cookie", "Content-Length"],
...
const routes = app
  ...
  .route("/contentGenres", contentGenresRouter)
